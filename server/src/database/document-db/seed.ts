...
const products: Prisma.ProductCreateInput[] = [
  ...
  },
  {
    title: "Umbrella",
    description:
      "An opened, dry umbrella. Generally depicted with purple fabric and a hooked handle. Commonly used for various content concerning rainy weather. Occasionally used as a purple accent color.",
    image: "/umbrella.svg",
  },
  {
    title: "Pencil",
